...
anovatable = stats(aovGABA);
posthoc = multcompare(aovGABA);
writetable(array2table([factors(:), GABA_tf_auc(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_tf_AUC_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_tf_AUC_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_tf_AUC_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovGlx);
posthoc = multcompare(aovGlx);
writetable(array2table([factors(:), Glx_tf_auc(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_tf_AUC_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_tf_AUC_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_tf_AUC_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovEIB);
posthoc = multcompare(aovEIB);
writetable(array2table([factors(:), EIB_tf_auc(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_tf_AUC_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_tf_AUC_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_tf_AUC_anova_posthoc.csv']);
...
anovatable = stats(aovGABA);
posthoc = multcompare(aovGABA);
writetable(array2table([factors(:), GABA_vg_degree_out(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_degree_out_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_degree_out_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_degree_out_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovGlx);
posthoc = multcompare(aovGlx);
writetable(array2table([factors(:), Glx_vg_degree_out(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_degree_out_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_degree_out_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_degree_out_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovEIB);
posthoc = multcompare(aovEIB);
writetable(array2table([factors(:), EIB_vg_degree_out(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_degree_out_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_degree_out_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_degree_out_anova_posthoc.csv']);
...
anovatable = stats(aovGABA);
posthoc = multcompare(aovGABA);
writetable(array2table([factors(:), GABA_vg_stationarity(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_stationarity_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_stationarity_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_GABA_vg_stationarity_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovGlx);
posthoc = multcompare(aovGlx);
writetable(array2table([factors(:), Glx_vg_stationarity(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_stationarity_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_stationarity_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_Glx_vg_stationarity_anova_posthoc.csv']);

% Output ANOVA results (table and posthoc test)
anovatable = stats(aovEIB);
posthoc = multcompare(aovEIB);
writetable(array2table([factors(:), EIB_vg_stationarity(:)]),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_stationarity_anova_inputdata.csv']);
writetable(anovatable(1:end, :),...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_stationarity_anova_table.csv']);
writetable(posthoc,...
            [resultspath, filesep, timestamp, '_', keyword, '_', fitpackage{fittingmethod},...
            '_EIB_vg_stationarity_anova_posthoc.csv']);
